...
this website goes over some of the important parts for developing a finshed website out side of the code that goes into it

~~ The challenge read me filr for the assignment for the class~~
